...
(function (Tokens) {
    ...
    Tokens.WAVAX = new WrappedToken({
        ...
        swapType: SwapType.AVAX,
        underlyingToken: Tokens.AVAX,
    });
    Tokens.MOVR = new BaseToken({
        name: "Moonriver",
        symbol: "MOVR",
        decimals: 18,
        addresses: {
    ...
    Tokens.WMOVR = new WrappedToken({
        ...
        swapType: SwapType.MOVR,
        underlyingToken: Tokens.MOVR,
    });
    // non-Synapse, non-stablecoin tokens
    Tokens.GOHM = new BaseToken({
        name: "Olympus DAO",
        symbol: "gOHM",
        decimals: 18,
        addresses: {
    ...
    Tokens.NFD = new BaseToken({
        name: "Feisty Doge",
        symbol: "NFD",
        decimals: 18,
        addresses: {
            [ChainId.BSC]: "0x0fe9778c005a5a6115cbe12b0568a2d50b765a51",
            [ChainId.POLYGON]: "0x0a5926027d407222f8fe20f24cb16e103f617046",
            [ChainId.AVALANCHE]: "0xf1293574ee43950e7a8c9f1005ff097a9a713959", // redeem
        },
        swapType: SwapType.NFD,
    });
    // FRAX/synFrax
    Tokens.FRAX = new BaseToken({
        name: 'Frax',
        symbol: 'FRAX',
        decimals: 18,
        addresses: {
    ...
    Tokens.mintBurnTokens = [
        Tokens.NUSD, Tokens.SYN, Tokens.NETH,
        Tokens.HIGH, Tokens.DOG, Tokens.JUMP,
        Tokens.FRAX, Tokens.SYN_FRAX, Tokens.NFD,
        Tokens.GOHM, Tokens.SOLAR, Tokens.GMX,
    ];
    function isMintBurnToken(token) {
        return Tokens.mintBurnTokens.map((t) => t.symbol).includes(token.symbol);
    }
    Tokens.isMintBurnToken = isMintBurnToken;
})(Tokens || (Tokens = {}));
